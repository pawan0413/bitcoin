...
{
    const char* pszTimestamp = "Bitcoin ig going to be cloned";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517300412, 0, 0x1d00ffff, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("103.212.71.88"); // Pieter Wuille, only supports x1, x5, x9, and xd
        ...
        chainTxData = ChainTxData{
            ...
            1517300412, // * UNIX timestamp of last known number of transactions
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1517300412, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));
